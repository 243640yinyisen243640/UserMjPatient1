...
public class IsHaveSugarUnitMultiCheckAdapter extends BaseQuickAdapter<String, BaseViewHolder> {
    ...
    public IsHaveSugarUnitMultiCheckAdapter(@Nullable List<String> datas) {
