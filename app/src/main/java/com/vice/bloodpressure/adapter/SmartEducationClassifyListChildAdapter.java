...
public class SmartEducationClassifyListChildAdapter extends CommonAdapter<SmartEducationBean.ArtlistBean> {

    private int learnState;

    public SmartEducationClassifyListChildAdapter(Context context, int layoutId, List<SmartEducationBean.ArtlistBean> datas, int learnState) {
        super(context, layoutId, datas);
        this.learnState = learnState;
    }

    @Override
    protected void convert(ViewHolder viewHolder, SmartEducationBean.ArtlistBean item, int position) {
