...
public class NonDrugSportMultiAdapterForSportBottom extends RecyclerView.Adapter {
    //布局类型
    ...
    public NonDrugSportMultiAdapterForSportBottom(List<NonDrugSportMultiBean> datas) {
        this.datas = datas;
        init();
    }
