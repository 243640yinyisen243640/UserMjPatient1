...
public class GvDietPlanSelectAdapter extends CommonAdapter<String> {
    private List<String> list;
    //默认选中第一个
    private int defaultSelection = 0;

    public GvDietPlanSelectAdapter(Context context, int layoutId, List<String> datas) {
    ...
    protected void convert(ViewHolder viewHolder, String item, int position) {
        ...
        int paddingWidth = SizeUtils.dp2px(2 * 12 + 1 * 12);
