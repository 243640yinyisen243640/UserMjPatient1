 ...
 * 描述:
 * 作者: LYD
 * 创建日期: 2020/10/28 17:30
 */
public class SevenBottomAdapter extends BaseQuickAdapter<SevenAndThirtyBloodSugarListBean.WeekBean.InfoBean, BaseViewHolder> {
    private Context context;

    public SevenBottomAdapter(@Nullable List<SevenAndThirtyBloodSugarListBean.WeekBean.InfoBean> data, Context context) {
        super(R.layout.item_home_blood_sugar, data);
        this.context = context;
    }

    @Override
    protected void convert(@NonNull BaseViewHolder viewHolder, SevenAndThirtyBloodSugarListBean.WeekBean.InfoBean infoBean) {
