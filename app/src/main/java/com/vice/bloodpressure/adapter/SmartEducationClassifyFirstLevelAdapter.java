...
public class SmartEducationClassifyFirstLevelAdapter extends XyBaseAdapter<SmartEducationClassifyLeftBean> {
    ...
    public SmartEducationClassifyFirstLevelAdapter(Context mContext, List<SmartEducationClassifyLeftBean> mList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.tvText.setText(mList.get(position).getClassname());
