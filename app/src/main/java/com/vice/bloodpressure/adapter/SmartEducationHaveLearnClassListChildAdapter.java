...
public class SmartEducationHaveLearnClassListChildAdapter extends CommonAdapter<SmartEducationHaveLearnClassListBean.ClassesBean> {
    ...
    public SmartEducationHaveLearnClassListChildAdapter(Context context, int layoutId, List<SmartEducationHaveLearnClassListBean.ClassesBean> datas,int learnState) {
        super(context, layoutId, datas);
        this.learnState = learnState;
    }

    @Override
    protected void convert(ViewHolder viewHolder, SmartEducationHaveLearnClassListBean.ClassesBean item, int position) {
