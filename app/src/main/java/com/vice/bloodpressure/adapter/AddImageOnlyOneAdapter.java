 ...
 * 描述:
 * 作者: LYD
 * 创建日期: 2020/5/20 15:12
 */
public class AddImageOnlyOneAdapter extends RecyclerView.Adapter<AddImageOnlyOneAdapter.ViewHolder> {
    ...
    public AddImageOnlyOneAdapter(Context context, onAddPicClickListener mOnAddPicClickListener) {
