 ...
 */
public class ThirtyBottomAdapter extends BaseQuickAdapter<SevenAndThirtyBloodSugarListBean.MonthBean.InfoBeanX, BaseViewHolder> {
    private Context context;

    public ThirtyBottomAdapter(@Nullable List<SevenAndThirtyBloodSugarListBean.MonthBean.InfoBeanX> data, Context context) {
        super(R.layout.item_home_blood_sugar, data);
        this.context = context;
    }

    @Override
    protected void convert(@NonNull BaseViewHolder viewHolder, SevenAndThirtyBloodSugarListBean.MonthBean.InfoBeanX infoBean) {
