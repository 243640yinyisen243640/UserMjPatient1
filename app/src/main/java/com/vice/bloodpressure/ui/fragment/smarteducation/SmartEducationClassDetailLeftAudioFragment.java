 ...
 * 创建日期: 2020/8/20 9:46
 */
public class SmartEducationClassDetailLeftAudioFragment extends BaseFragment {
    ...
    protected int getLayoutId() {
        return R.layout.fragment_smart_education_class_detail_left_audio;
    }
    ...
    protected void init(View rootView) {
        initProgress();
        setWebView();
        String duration = getArguments().getString("audioDuration");
    ...
    public void onViewClicked() {
        ...
        if (isOddNumber(clickCount)) {
            ...
            String audioUrl = getArguments().getString("audioUrl");
            //开始播放
