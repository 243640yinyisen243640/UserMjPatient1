 ...
 * 创建日期: 2020/8/20 9:35
 */
public class SmartEducationClassDetailTextActivity extends BaseHandlerActivity {
    ...
    protected View addContentLayout() {
        View view = getLayoutInflater().inflate(R.layout.activity_smart_education_class_detail_text, contentLayout, false);
        return view;
    }
