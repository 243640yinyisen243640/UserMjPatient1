...
public class BloodWarningFragment extends BaseFragment {

    private static final int GET_DATA = 0x6998;

    private ListView lvBloodWarning;
    ...
    public void processHandlerMsg(Message msg) {
        switch (msg.what) {
            case GET_DATA:
                ...
                WarningAdapter warningAdapter = new WarningAdapter(mContext, wmList, "blood");
                lvBloodWarning.setAdapter(warningAdapter);
                break;
        }
    }
    ...
    protected int getLayoutId() {
        return R.layout.fragment_blood_warning;
    }

    @Override
    protected void init(View view) {
        lvBloodWarning = view.findViewById(R.id.lv_blood_warning);
        getData();
    }
    ...
    private void getData() {
        ...
        XyUrl.okPost(XyUrl.GET_BLOOD_YWORNING, map, new OkHttpCallBack<String>() {
            @Override
