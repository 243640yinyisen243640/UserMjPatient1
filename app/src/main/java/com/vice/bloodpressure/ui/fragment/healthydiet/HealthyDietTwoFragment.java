 ...
 */
public class HealthyDietTwoFragment extends BaseFragment {
    private static final String TAG = "HealthyDietTwoFragment";
    private static final int GET_FIRST_CLASSIFY = 10086;
    private static final int GET_ERROR = 10087;
    private static final int GET_SEARCH = 10088;
    ...
    private void initFragment() {
        ...
        for (int i = 0; i < listTitle.length; i++) {
            HealthyDietChildTwoFragment childFragment = new HealthyDietChildTwoFragment();
        ...
        tblList.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                EventBusUtils.post(new EventMessage(ConstantParam.FOOD_REFRESH));
            }
    ...
    private void toSearch() {
        ...
        EventBusUtils.post(new EventMessage(ConstantParam.FOOD_SEARCH, keyWord, currentPosition + ""));
    }
            ...
            case GET_FIRST_CLASSIFY:
                ...
                if (list != null && list.size() > 0) {
                    for (int i = 0; i < list.size(); i++) {
                        ...
                        //一级类名
                        String foodLei = data.getFoodlei();
